  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-primary-foreground hover:brightness-110 shadow-glow",
        accent: "gradient-accent text-accent-foreground hover:brightness-110 shadow-accent-glow",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border-2 border-border bg-card hover:bg-secondary hover:border-primary/40",
      ...
      size: {
        ...
        lg: "h-13 rounded-2xl px-7 text-base h-14",
        xl: "h-16 rounded-2xl px-8 text-base",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
